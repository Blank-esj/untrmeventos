...
one `180×180px` touch icon named `fisme.png` and including the following in
the `<head>` of the page is enough:

```html
<link rel="apple-touch-icon" href="fisme.png" />
```
...
```html
<link rel="icon" sizes="192x192" href="highres-fisme.png" />
```
