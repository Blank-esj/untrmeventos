...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Editar Categorías
      <small>Aquí podrás modificar la categoría seleccionada.</small>
    </h1>
  </section>
  <div class="row">
    <div class="col-md-12">
          ...
          <form method="post" action="dashboard">
            <div class="box-body">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="nombre_categoria" name="nombre_categoria" placeholder="Ingrese el nombre" value="<?Php echo $categoria['cat_evento']; ?>">
              </div>
