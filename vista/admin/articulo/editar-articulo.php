...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Editar Artículos
            <small>Aquí podrás modificar el artículo seleccionado.</small>
        </h1>
    </section>
                    ...
                    <form method="post" action="dashboard" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <h6 class="help-block">Agregar la imagen del articulo aquí.</h6>
                            </div>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control" id="btextarea" name="descripción" placeholder="Ingrese una descripción"><?php echo $articulo['descripcion']; ?></textarea>
                            </div>
