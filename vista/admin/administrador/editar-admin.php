...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small> Aquí podrás modificar el administrador seleccionado.</small>
    </h1>
  </section>
  <div class="row">
    <div class="col-md-12">
          ...
          <form method="post" action="dashboard" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Ingrese el nombre (es)" value="<?php echo $persona['nombres']; ?>">
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="doc_identidad" name="doc_identidad" placeholder="Ingrese un documento de identidad" value="<?php echo $persona['doc_identidad']; ?>">
              </div>

              <!-- Usuario -->
              <div class="form-group col-md-4">
                <label for="usuario">Usuario: </label>
                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Ingrese el usuario" value="<?php echo $admin['usuario']; ?>">
              </div>
