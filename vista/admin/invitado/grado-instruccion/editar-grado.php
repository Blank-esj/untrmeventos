        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    ...
                    <small>Aquí podrás modificar grado académico seleccionado.</small>
                </h1>
            </section>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese el nombre" value="<?php echo $grado['grado']; ?>">
                                            </div>
