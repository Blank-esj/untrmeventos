...
$(document).ready(function () {
  ...
  $("#repetir_password").on("input", function () {
    ...
    if ($(this).val() == password_nuevo) {
      ...
      $("#resultado_password")
        ...
        .removeClass("has-error"); //Traversing desde el spam al div FORM GROUP. añade clases y remueve
      $("input#password")
        .parents(".form-group")
        .addClass("has-success")
        .removeClass("has-error"); // Añade clases al input contraseña
  ...
  $("#nivel").change(function () {
    ...
    if (nivel_usuario == 0) {
      $("#resultado_nivel_usuario").text(
        "Este usuario no podrá crear usuarios administradores."
      );
    } else {
      $("#resultado_nivel_usuario").text(
        "Este usuario podrá crear usuarios administradores."
      );
    }
  });
