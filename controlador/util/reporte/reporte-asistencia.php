...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(92);
        // Title
        $this->Cell(85, 12, 'ASISTENCIA', 0, 0, 'C');
        // Line break
        $this->Ln(12);
        $this->SetFillColor(240, 240, 240);
        $this->Cell(10, 11, utf8_decode('Nº'), 1, 0, 'C', 1);
        $this->Cell(65, 11, 'NOMBRES Y APELLIDOS', 1, 0, 'C', 1);
        $this->Cell(27, 11, 'DOC. ID', 1, 0, 'C', 1);
        $this->Cell(30, 11, 'TEL.', 1, 0, 'C', 1);
        $this->Cell(65, 11, 'E-MAIL', 1, 0, 'C', 1);
        $this->Cell(25, 11, 'ESTADO', 1, 0, 'C', 1);
        $this->Cell(45, 11, 'FIRMA', 1, 1, 'C', 1);
    }
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(27, 10, $row['doc_identidad'], 1, 0, 'C', 0);
    $pdf->Cell(30, 10, $row['telefono'], 1, 0, 'C', 0);
    $pdf->Cell(65, 10, utf8_decode($row['email']), 1, 0, 'C', 0);
    $pdf->Cell(25, 10, utf8_decode($row['estado_venta']), 1, 0, 'C', 0);
