  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><a href="admin-area.php">MENU DE ADMINISTRACION</a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="dashboard.php"><i class="fas fa-chart-line" aria-hidden="true"></i> Dashboard </a></li>
          </ul>
        </li>
        ...
        ?>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="generar-reportes.php"><i class="far fa-file-pdf"></i> Generar</a></li>
            </ul>
          </li>
        <?php endif;
        ?>
