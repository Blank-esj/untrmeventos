              ...
              <form role="form">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <button type="button" class="btn btn-primary" onclick="location.href='reporte-administrador.php'">
                    ...
                    <div class="form-group">
                      ...
                      <button type="button" class="btn btn-primary" onclick="location.href='reporte-registrado.php'">
                        <i class="fas fa-print"></i>
                      </button>
                    </div>
                    <div class="form-group">
                      ...
                      <button type="button" class="btn btn-primary" onclick="location.href='reporte-invitado.php'">
                        <i class="fas fa-print"></i>
                      </button>
                    </div>
                    <div class="form-group">
                      ...
                      <button type="button" class="btn btn-primary" onclick="location.href='reporte-evento.php'">
                        <i class="fas fa-print"></i>
                      </button>
                    </div>
                  </div> <!-- /.box-body -->
